...
class MainActivity : AppCompatActivity(), OnMapReadyCallback,
    ...
    // Implementa el fragment del mapa
    ...
    // Sirve pra saber si se ha dado el permiso
    private fun isPermissionsGranted() = ContextCompat.checkSelfPermission(
        this,
        Manifest.permission.ACCESS_FINE_LOCATION
    ) == PackageManager.PERMISSION_GRANTED
    // Comprueba si el mapa se ha iniciado y los permisos de la siguiente función
    ...
    // Esto nos dice si acepta los permisos que le dimos
    ...
    // Muestra la latitud y la longitud
    override fun onMyLocationClick(p0: Location) {
        Toast.makeText(this, "Estás aquí ${p0.latitude}, ${p0.longitude}", Toast.LENGTH_SHORT).show()
    }
}